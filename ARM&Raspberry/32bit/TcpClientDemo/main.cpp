...
void ReadAnswerMode(void)
{
	...
	if (CFNet_InventoryG2(0xFF,arrBuffer,&iTagLength,&iTagNumber) == FALSE)
	{
		//cout<<"Failed"<<endl;
		return;
	}
...
int main()
{
    ...
    cin>>strDev>>iPort;
    //if(CFNet_OpenDevice((char *)"192.168.1.250",60000) == FALSE)
    if(CFNet_OpenDevice(strDev,iPort) == FALSE)
    {
    ...
    switch(key)
    {
        case 0://readRFPower
                ...
                07: UartBaudRate*/
            bParamAddr = 0x05;
            if (CFNet_ReadDeviceOneParam(0xFF,bParamAddr, &bValue) == FALSE)
            {
                cout<<"Failed"<<endl;
                return 0;
            }
        ...
        case 1: //SetRF
            ...
            cin >>bValue;
            if (CFNet_SetDeviceOneParam(0xFF,bParamAddr, bValue) == FALSE)
            {
                cout<<"Failed"<<endl;
                return 0;
            }
            ...
            break;
        case 2://WriteTag
            if (CFNet_WriteCardG2(0xFF,Password,Mem,WordPtr,WriteLen,Writedata) == FALSE)
            {
                cout<<"Failed"<<endl;
                return 0;
            }
        ...
        case 6://callback mode
            ...
            cout<<"Q: exit"<<endl;
            CFNet_SetCallback(CallBackFunc);
            break;
        case 7://stop
            if (CFNet_StopRead(0xFF) == FALSE)
            {
                cout<<"Failed"<<endl;
                return 0;
            }
